...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Fundo com notas de dinheiro sutis */
        body::before {
            content: "";
            position: fixed;
            top: 0;
            ...
            background-image: 
                ...
                url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 200 200"><rect width="200" height="200" fill="none"/><path d="M40,50 L160,50 L160,90 L40,90 Z" fill="%2310b981" opacity="0.03"/><path d="M50,110 L150,110 L150,140 L50,140 Z" fill="%2310b981" opacity="0.03"/><circle cx="100" cy="170" r="15" fill="%2310b981" opacity="0.03"/></svg>');
...
<body>
    <div class="container">
        <div class="hero-section">
            ...
            <h1 class="hero-title">
                Conectamos talentos a oportunidades reais de trabalho
            </h1>
            
            <p class="hero-subtitle">
                Cadastre-se gratuitamente e tenha acesso a vagas exclusivas de empresas que valorizam seu potencial.
            </p>
            
            <div class="features">
                <div class="feature floating" style="animation-delay: 0s;">
    ...
    <script>
        document.getElementById('registration-form').addEventListener('submit', function(e) {
            ...
            setTimeout(() => {
                ...
                // Por exemplo: enviarParaServidor(coletarDadosFormulario());
        ...
        // Função para enviar para servidor (para uso futuro)
